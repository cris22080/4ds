...
public class PrentotazioneErbaSintetica extends PrenotazioneCampo {


    public PrentotazioneErbaSintetica(String nome, LocalDateTime dataInizio, LocalDateTime dataFine) {
